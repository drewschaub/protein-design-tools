...
rg_ideal_helix = protein_structure_utils.get_radgyr_alanine_helix(
    ideal_helix_seq_length, atom_type="backbone"
)
...
rg_ratio = protein_structure_utils.get_radgyr_ratio(
    protein, chains="A", atom_type="backbone"
)
